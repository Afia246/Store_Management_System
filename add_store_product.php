...
// Handle form submission for adding store product
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['store_product_name']) && isset($_POST['store_product_quantity']) && isset($_POST['store_product_entry_date'])) {
        ...
        $stmt->bind_param("sis", $store_product_name, $store_product_quantity, $store_product_entry_date);
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add Store Product</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="./">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Add Store Product</li>
                        </ol>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Insert Store Product</h6>
                                </div>
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="store_product_quantity" class="form-control" id="storeProductQuantity" min="1" required>
                                        </div>
                                        ...
                                        <div class="form-group" id="datePicker">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="store_product_entry_date" class="form-control" value="<?php echo $date; ?>" id="storeProductEntryDate" required>
                                            </div>
                                        </div>
